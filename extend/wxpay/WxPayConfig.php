...
{
	private $AppId, $MerchantId, $SignType, $Key, $AppSecret; 
	public function __construct($data) {
		isset($data['AppId']) && $this->AppId = $data['AppId'];
		isset($data['MerchantId']) && $this->MerchantId = $data['MerchantId'];
		isset($data['SignType']) && $this->SignType = $data['SignType'];
		isset($data['Key']) && $this->Key = $data['Key'];
		isset($data['AppSecret']) && $this->AppSecret = $data['AppSecret'];
	}
	//=======【基本信息设置】=====================================
	/**
